...
int main(int argc, char const *argv[])
{
    ...
    // set units per count on encoder (get_position() will return radians, make 360.0/500.0 if degrees preferred)
    ...
    while(!STOP) {
        ...
        // --------------------------------------------------------------------
        //
        // The code here is not what you will use for your project,
